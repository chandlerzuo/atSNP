...
(a) Computing the binding affinity score for each allele and each PWM.
(b) Computing the p-values for allele-specific binding affinity scores.
(c) Computing the p-values for affinity score changes between the two alleles for each SNP.
